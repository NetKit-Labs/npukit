...
**WIP:** MNIST tiny-ViT at T=8 with QAT + calibrated scales (`train_vit_mnist.py`). Float ~81%, quantized ref ~79%. **Optional later:** T=16 after glue-len rebuild, ping-pong, depthwise, AXIS stimulus in `npukit_axil_tb`.
